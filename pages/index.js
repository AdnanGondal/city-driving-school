    ...
    `}
      ...
      <main className="">
        ...
        <section id="about" className="p-4 md:p-20 text-center md:pb-5">
          <h2 className="text-2xl text-blue-600 font-bold md:text-3xl py-10">Why Choose City Driving School?</h2>
          ...
          <div className="rounded-lg shadow-lg p-8 max-w-4xl bg-blue-50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              <div className="p-4">
                ...
                <h3 className="text-xl text-red-600 font-bold mb-2">Beginners Lessons</h3>
              ...
              <div className="p-4">
                ...
                <h3 className="text-xl text-red-600 font-bold mb-2">Advanced Lessons</h3>
              ...
              <div className="p-4">
                ...
                <h3 className="text-xl text-red-600 font-bold mb-2">Motorway Lessons</h3>
